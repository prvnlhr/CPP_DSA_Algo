...
{
    set<char> rowOne{'q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p'};
    set<char> rowTwo{'a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l'};
    set<char> rowThree{'z', 'x', 'c', 'v', 'b', 'n', 'm'};

    char firstLetter = tolower(word[0]);
    int count = 0;

    if (rowOne.count(firstLetter))
    {
        for (int i = 0; i < word.size(); i++)
        {
            if (rowOne.count(tolower(word[i])))
            {
                count++;
            }
        }
    ...
    else if (rowTwo.count(firstLetter))
    {

        for (int i = 0; i < word.size(); i++)
        {
            if (rowTwo.count(tolower(word[i])))
            {
                count++;
            }
        }
    ...
    else if (rowThree.count(firstLetter))
    {

        for (int i = 0; i < word.size(); i++)
        {
            if (rowThree.count(tolower(word[i])))
            {
                count++;
            }
        }
...
void solve()
{
    ...
    vector<string> input{"Aasdfghjkl", "Qwertyuiop", "zZxcvbnm"};
