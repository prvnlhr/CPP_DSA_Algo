...
** YOU CAN ONLY BUY ONE AND SELL ONE, CANT HOLD MORE THEN ONE SHARE
...
- this transaction. If you cannot achieve any profit, return 0.d.
...
>Approach :
- if at any point the profit becomes negative for a buyPrice,
- then we will update the buyPrice to current prices[i]
...
/*
> Striver : keep buyPrices minimum, i.e if we are selling at prices[i],
> then we will buy it at smallest prices in past. So maintain buyPrice minimum of leftside of,
> current price
...
int maxProfit2(vector<int> &prices)
{
    ...
    for (int i = 1; i < prices.size(); i++)
    {
        ...
        maxPro = max(maxPro, prices[i] - buyPriceMin);
    }
