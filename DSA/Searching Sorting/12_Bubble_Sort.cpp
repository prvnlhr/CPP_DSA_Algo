...
- will be false. This means elements are already sorted and there is no
- need to perform further iterations.This will reduce the execution
- time and helps to optimize the bubble sort.
*/
