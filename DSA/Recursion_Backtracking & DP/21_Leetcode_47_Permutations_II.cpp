...
//|> ---ＳＯＬＶＥ-----------------------------------------------------------------------------------------------------------------------------------------------
void helper(vector<int> &nums, vector<vector<int>> &res, int idx, set<vector<int>> &st)
{
    if (idx == nums.size() - 1)
    {
        st.insert(nums);
    ...
    for (int i = idx; i < nums.size(); i++)
    {
        ...
        helper(nums, res, idx + 1, st);
        swap(nums[idx], nums[i]);
    }
}
void helperBetter(vector<int> nums, vector<vector<int>> &res, int idx)
{
    if (idx == nums.size())
    {
        res.push_back(nums);
