...
TreeNode<int> *lowestCommonAncestor1(TreeNode<int> *root, TreeNode<int> *p, TreeNode<int> *q)
{
    ...
    TreeNode<int> *left = lowestCommonAncestor1(root->left, p, q);
    TreeNode<int> *right = lowestCommonAncestor1(root->right, p, q);
...
void solve()
{
    ...
    TreeNode<int> *p = new TreeNode(5);
    TreeNode<int> *q = new TreeNode(4);
