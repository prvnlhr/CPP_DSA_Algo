...
int minRow(int N, int M, vector<vector<int>> A)
{
    ...
    for (int currRowIndex = 0; currRowIndex < N; currRowIndex++)
    {
        vector<int> currRow = A[currRowIndex];

        int currColIndex = colIndex;
        while (currColIndex >= 0 && currRow[currColIndex] == 1)
        {
            currColIndex--;
        }
