...
//|> Also check : https://leetcode.com/problems/power-of-four/solutions/772428/c-three-solution-explain-naive-bit-manipulation/
bool isPowerHelper(int x, int n)
{
    if (x == n)
    {
        return true;
