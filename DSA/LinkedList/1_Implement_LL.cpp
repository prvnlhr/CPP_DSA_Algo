...
void deleteNodeAtIndex(LLNode *head, int index)
{
    ...
    else
    {
        ...
        // debug(prev->data, curr->data, curr->next->data);
...
int getNodeAtIndex(LLNode *head, int index)
{
    int cnt = 0;
...
void solve()
{
    ...
    vector<int> inputList{5, 2, 6, 2, 1, -1};
    ...
    printLL(head);
    cout << getNodeAtIndex(head, 5) << endl;
}
