...
LLNode *remove_Dups(LLNode *head)
{

    LLNode *dummy = new LLNode(INT_MAX);
    printLL(head);
...
void solve()
{
    vector<int> input{1, 2, 2, 3, 3, 4, 5, INT_MIN};
    // vector<int> input{1, 2, 2, 3, 3, 5, 5, 6,INT_MIN};
    // vector<int> input{1, 1, 2, 2, 3, 3, 5, 5, 6,INT_MIN};
