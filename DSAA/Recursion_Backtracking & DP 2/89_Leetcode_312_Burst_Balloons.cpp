...
//|> --- SOLVE -----------------------------------------------------------------------------------------------------------------------------------------------
int burstRecursiveMemo(vector<vector<int>> &dp, const vector<int> &nums, int left, int right)
{
    if (left + 1 == right)
        return 0;
    ...
    for (int i = left + 1; i < right; i++)
    {
        ...
        int a = burstRecursiveMemo(dp, nums, left, i);
        int b = burstRecursiveMemo(dp, nums, i, right);
        ans = max(ans, curr + a + b);
    }
...
int maxCoins(vector<int> &nums)
{
    ...
    //|> adding 1 before first and after last  elements
    for (int i = 1; i <= n; ++i)
    {
        arr[i] = nums[i - 1];
    }
    ...
    return burstRecursiveMemo(dp, arr, 0, n + 1);
}
