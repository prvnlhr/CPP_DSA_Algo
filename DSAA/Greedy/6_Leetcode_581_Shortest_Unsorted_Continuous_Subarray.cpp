...
// |> https://leetcode.com/problems/shortest-unsorted-continuous-subarray/solutions/862701/c-o-n-time-and-o-1-extra-space-solution-with-explanation/
int findUnsortedSubarrayOP(vector<int> &arr)
{
    int n = arr.size();
    int l = -1, r = -1;
    for (int i = 0; i < n - 1; i++)
