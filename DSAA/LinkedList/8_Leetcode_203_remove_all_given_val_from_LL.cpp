...
LLNode *remove_Val_node_from_last(LLNode *head, int val)
{
...
void solve()
{
    // vector<int> input{1, 2, 3, 6, 4, 5, 6, -1};
    // vector<int> input{1, 2, 3, 6, 5, 5, 6, -1};
    ...
    while (t--)
    {
        ...
        auto newHead = remove_Val_node_from_last(head, val);
        printLL(newHead);
    }
}
