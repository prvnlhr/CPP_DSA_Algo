...
void solve()
{
    ...
    FOR(i, 0, n)
    {
        ...
        if (48 <= typed[i] && typed[i] <= 57)
        {
            res += typed[i];
        }
        else if (65 <= typed[i] && typed[i] <= 90)
        {
            int indx = mpp[tolower(typed[i])];
            char curr = second[indx];

            res += toupper(curr);
        }
        else if (97 <= typed[i] && typed[i] <= 122)
        {

            int indx = mpp[typed[i]];
            char curr = second[indx];
